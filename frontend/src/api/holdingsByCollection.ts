...
//   const holdingsWithTimeHolded = holdings.filter(
//     (holding) => holding.timeHolded > 0
//   );

//   // should make mean of time holded grouped by owner id
//   const meanTimeHoldedByOwner = holdingsWithTimeHolded.reduce(
//     (acc, holding) => {
...
//   const topOwners = sortedOwners.slice(
//     0,
//     Math.floor(sortedOwners.length * percentage)
//   );
